...
public class TagAnnotation extends Annotation {
   ...
   * @ordered
   */
  public final static int typeIndexID = JCasRegistry.register(TagAnnotation.class);
   ...
   * @generated
   */
  public TagAnnotation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   * @generated
   */
  public TagAnnotation(JCas jcas) {
    super(jcas);
    readObject();
  }
   ...
   * @generated
   */
  public TagAnnotation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
