...
public class Entity_Type extends TOP_Type {
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.jcas.cas.Entity");
  ...
  public int getOccurrencies(int addr) {
    if (featOkTst && casFeat_occurrencies == null)
      jcas.throwFeatMissing("occurrencies", "org.apache.uima.jcas.cas.Entity");
  ...
  public String getText(int addr) {
    if (featOkTst && casFeat_text == null)
      jcas.throwFeatMissing("text", "org.apache.uima.jcas.cas.Entity");
