...
import com.cybion.cpt.web.core.business.WebpipeExecutor;
...
public class CrawlingAction implements CybionAction {
	...
	public boolean doWork(HttpServletRequest request) {
		...
		try {
			...
			NavigationXML xml = broker.getNavXML(idFonte);
...
//			List<Relation> relationList = new LinkedList<Relation>();
			...
			List<CrawledPage> paginaList = new LinkedList<CrawledPage>(); //lista di appoggio per stampare il messaggio
			CrawledPage pagina = new CrawledPage();
